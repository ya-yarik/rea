...
//        model.addAttribute("role", userOperations.getUserId(id));
//        return "setrole";
//    }
//
//    @PostMapping("/users/setrole/{id}")
//    public String changeRole(@PathVariable("id") int id, Model model, @ModelAttribute("role") @Valid UserModel userModel) {
//        model.addAttribute("role", usersRepository.findAll());
//        userOperations.changeRole(id, userModel);
//        return "redirect:/admin/users";
//    }

//    @GetMapping("/users/setrole/{id}")
//    public String changeRoleBack(@PathVariable("id") int id, Model model){
//        model.addAttribute("user", usersRepository.findAll());
//        model.addAttribute("role", userOperations.getUserId(id));
//        return "setrole";
//    }
//
//    @PostMapping("/users/setrole/{id}")
//    public String changeRoleBack(@PathVariable("id") int id, Model model, @ModelAttribute("roleBack") @Valid UserModel userModel) {
//        model.addAttribute("roleBack", usersRepository.findAll());
//        userOperations.changeRole(id, userModel);
//        return "redirect:/admin/users";
//    }
//    @GetMapping("/order/changerole")
...
//        model.addAttribute("productOwner", productOwnerRepository.findAll());
    ...
    public String orderStatus(@ModelAttribute("order") @Valid Orders orders, BindingResult scanGoodsEditFields, @PathVariable("id") int id, Model model) {
...
//    public String changeRole(UserModel userModel, @PathVariable("id") int id) {
//        userOperations.changeRole(id, userModel);
//        return "redirect:/admin/users";
//    }
...
//    public String changeRole (@ModelAttribute("order") @Valid Orders orders, BindingResult scanGoodsEditFields, @PathVariable("id") int id, Model model) {
//        ordersServices.orderStatus(id, orders);
//        return "redirect:/admin/orders";
//    }
    ...
    @PostMapping("/user/changerole/{id}")
    public String changeRole(@ModelAttribute("userForm") @Valid UserModel user, BindingResult scanEdit, @PathVariable("id") int id, Model model, @RequestParam("file") MultipartFile multipartFile) {
        if (scanEdit.hasErrors()) {
            return "personaldata";
        }
